...
- Renamed the app to Curated Closet, added branded sign-in/logo assets plus a new favicon, refreshed the home sign-in copy, and switched signed-out auth fallbacks to a single standalone sign-in screen without the main app shell.
