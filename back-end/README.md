...
- stores validated `page_layouts` JSON keyed by `cover` or `outfit:<id>`, including flat-lay/modeled choice and percentage geometry/text for the image, title, and body layers
